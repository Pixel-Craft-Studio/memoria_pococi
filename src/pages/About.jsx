        ...
        <>
            <div className="flex flex-col items-center">
                <div className="flex flex-col w-3/4 mt-15">
                    ...
                    <p className="text-md font-medium my-5">{response.data.content.description}</p>
                </div>

                <img className="my-5 rounded-xl h-60 w-3/4 object-cover" src={response.data.content.image_url} alt="About" />
