...
import { FiHome, FiSettings, FiLogOut, FiChevronDown, FiEye, } from "react-icons/fi";
...
const Sidebar = () => {
  ...
  return (
    <div className={`flex ml-50`}>
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full bg-gray-200 dark:bg-gray-800 p-3 flex flex-col transition-all duration-300 ease-in-out`}
      >
        ...
        <nav className="flex-1 mt-6">
          <ul className="space-y-4">
            <Link
              to="/dashboard"
              className="flex items-center space-x-3 p-3 rounded-lg cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-700"
            >
