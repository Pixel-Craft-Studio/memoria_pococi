...
const PeriodTable = ({ setFormData, changeStage, updateSignalState }) => {
  ...
  const handleEdit = (item) => {
    setFormData({ id: item.id, year: item.year, title: item.title, description: item.description, image_url: item.image_url });
    changeStage(UPDATE);
  };
        ...
        <table className="min-w-full bg-white dark:bg-gray-800 table-auto">
          <thead className="bg-gray-100 dark:bg-gray-700">
            <tr>
              ...
              <th className="px-4 py-2 border-b border-gray-200 dark:border-gray-600 text-center w-[100px]">
                Estado
              </th>
            </tr>
          </thead>
                  ...
                  <td className="px-4 py-2 border-b border-gray-200 dark:border-gray-600">
                    <div className="flex justify-between items-center">
                      <div className="pl-2">
                        ...
                        <div className="overflow-hidden text-ellipsis whitespace-normal pr-5">
                          {item.description}
                        </div>

                        <div className="mt-2">Historias Asociadas: <b className="text-green-600">{item.histories.length}</b></div>
                        <div>
