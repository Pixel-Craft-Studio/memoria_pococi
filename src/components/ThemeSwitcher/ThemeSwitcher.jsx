...
const ThemeSwitcher = () => {
  ...
  return (
    <div
      onClick={toggleTheme}
      className="relative hover:rotate-360 bg-neutral-600 dark:bg-gray-100 w-6 h-6 cursor-pointer rounded-full transition-all duration-300 flex items-center justify-center"
    >
      <SunIcon
