    ...
    return (
        <>
            <div className="flex justify-around items-center bg-gray-300 w-full">
                ...
                <Link to={'/'}><img className='h-20 w-20 p-2 rounded-2xl' src="/imgs/logo.png" alt="Municipalidad Pococi" /></Link>
                ...
                <div className='flex gap-4 lg:flex-row'>
                    ...
                    <Link className='font-bold text-gray-500 hover:text-green-800' to="/contact">Contáctenos</Link>
                </div>
            </div>
        </>
    );
